(function createSystemBodies() {
    ...
    [{ r: 6.2, o: 0.028 }, { r: 8.8, o: 0.014 }, { r: 13.0, o: 0.006 }].forEach(function (layer) {
        var coronaMesh = new THREE.Mesh(
            new THREE.SphereGeometry(layer.r, 32, 32),
            new THREE.MeshBasicMaterial({ color: Orbital.palette.sun, transparent: true, opacity: layer.o, side: THREE.BackSide })
        );
    ...
    Orbital.planetData = [
        {
            ...
            radius: 0.22, orbitRadius: 4.5,  orbitSpeed: 0.45, orbitOffset: 1.2,  tilt: 0.01
        },
        {
            name: null, interactive: false,
            outlineColor: 0xd4b060,   // Venus — pale gold
            radius: 0.45, orbitRadius: 6.8,  orbitSpeed: 0.35, orbitOffset: 3.8,  tilt: -0.02
        },
        {
            name: "Projects", panelId: "projects-panel", interactive: true,
            outlineColor: 0x3a6eb5,   // Earth — blue
            radius: 0.9, orbitRadius: 9.2,  orbitSpeed: 0.22, orbitOffset: 0.4,  tilt: -0.03,
            focusDistance: 2.8
        },
        {
            name: null, interactive: false,
            outlineColor: 0xb04020,   // Mars — red-orange
            radius: 0.35, orbitRadius: 11.8, orbitSpeed: 0.17, orbitOffset: 2.1,  tilt: 0.02
        },
        {
            name: "Skills", panelId: "skills-panel", interactive: true,
            outlineColor: 0xc07840,   // Jupiter — orange-tan
            radius: 1.35, orbitRadius: 16.5, orbitSpeed: 0.10, orbitOffset: 4.3,  tilt: -0.04,
            focusDistance: 3.8
        },
        {
            name: "Contact", panelId: "contact-panel", interactive: true,
            outlineColor: 0xd4c060,   // Saturn — pale gold
            radius: 1.10, orbitRadius: 22.5, orbitSpeed: 0.072, orbitOffset: 5.5, tilt: 0.03,
            focusDistance: 4.2, hasRings: true
        },
        {
            name: null, interactive: false,
            outlineColor: 0x70d8d0,   // Uranus — pale aqua
            radius: 0.70, orbitRadius: 27.5, orbitSpeed: 0.050, orbitOffset: 2.9, tilt: -0.02
        },
        {
            name: null, interactive: false,
            outlineColor: 0x2848b0,   // Neptune — deep blue
            radius: 0.65, orbitRadius: 32.5, orbitSpeed: 0.036, orbitOffset: 1.7, tilt: 0.01
        }
    ];
    ...
    Orbital.planetData.forEach(function (data) {
        // Orbit ring
        var orbitGeometry = new THREE.RingGeometry(data.orbitRadius - 0.018, data.orbitRadius + 0.018, 128);
    ...
    var beltMat = new THREE.PointsMaterial({ color: 0x9a9080, size: 0.18, transparent: true, opacity: 0.5 });
